...
public class MRankingListAdapter extends BaseAdapter{
    private final Context mContext;
    private final  List<RankDb.DataBean.YingliWeekBean> list;
    public MRankingListAdapter(Context context, List<RankDb.DataBean.YingliWeekBean> datas) {
