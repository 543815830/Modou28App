...
public class MyFechAdapter2 extends BaseAdapter {
    private Context mContext;
    List<GoldDepositDb.DataBean.CardlistBean> fechlist;
    public MyFechAdapter2(Context mContext, List<GoldDepositDb.DataBean.CardlistBean> fechlist) {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        if (mHashMap.get(i) == null) {
            ...
            viewHolder.tv_type.setText(fechlist.get(i).getTypename()+"("+fechlist.get(i).getRealname()+")");
