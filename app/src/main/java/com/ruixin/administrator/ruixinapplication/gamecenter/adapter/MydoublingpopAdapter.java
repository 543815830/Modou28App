 ...
 * 邮箱：543815830@qq.com
 */
public class MydoublingpopAdapter extends BaseAdapter {
    private Context mContext;
    private List<DoublingBetInfoDb.DataBean.ModellistBean>list;
    //本地字段，用户recyclerview保存状态
    public boolean isSelected = false;
    public MydoublingpopAdapter(Context context, List<DoublingBetInfoDb.DataBean.ModellistBean>list){
