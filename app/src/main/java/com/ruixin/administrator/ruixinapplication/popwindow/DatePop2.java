...
public class DatePop2 extends PopupWindow {
    ...
    public DatePop2(Context paramActivity, int paramInt1, int paramInt2, final List<String>list, OnClickListener onclick, final TextView textView){
        super(paramActivity);
        //窗口布局
