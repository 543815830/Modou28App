...
public class SignCalendar extends ViewFlipper implements GestureDetector.OnGestureListener {
    public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#339ef9"); // 星期标题背景颜色
    ...
    public static final int COLOR_TX_THIS_DAY = Color.parseColor("#339ef9"); // 当天日历数字颜色
    public static final int COLOR_BG_THIS_DAY = Color.parseColor("#339ef9"); // 当天日历背景颜色
    public static final int COLOR_BG_CALENDAR = Color.parseColor("#f2f8ff"); // 日历背景色
    public static final int COLOR_BG_CALENDAR_2 = Color.parseColor("#d6ecfe"); // 日历背景色2
    ...
    private String[][] dates = new String[5][7]; // 当前日历日期
    private float tb;
    ...
    private void drawFrame(LinearLayout oneCalendar) {
        ...
        title.setBackgroundColor(COLOR_BG_WEEK_TITLE);//日历title的背景色,蓝色，星期的颜色一二三四五339ef9
        ...
        tb = res.getDimension(R.dimen.historyscore_tb);//每个格子的大小
        ...
        content.setLayoutParams(new LinearLayout.LayoutParams(-1, 0, 5f));
            ...
            for (int j = 0; j < COLS_TOTAL; j++) {
                ...
                if (i == 0 && j == 0 && weekday != 0) {
                    ...
                    for (int k = 0; k < weekday; k++) {
                      ...
                      /*  if(lastMonthDay%2==0){
                            view.setBackgroundColor(COLOR_BG_CALENDAR_2);//设置日历背景色
                        }*/

                        view.setText(Integer.toString(lastMonthDay));
                        view.setTextColor(COLOR_TX_OTHER_MONTH_DAY);//其他日历数字的颜色
