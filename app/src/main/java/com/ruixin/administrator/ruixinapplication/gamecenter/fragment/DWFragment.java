...
public class DWFragment extends BaseFragment {
    private View view;
    ListView game_number_lv;
    int []array;
    double[] rate;
    int[]money;
    DWGameNumberAdapter numberAdapter;
    String mulp="1";
    Double mp1;
    String totalPints1;
        ...
        if(view==null){
            ...
            mybetpoints=RuiXinApplication.getInstance().getMybetPoints();
                if(numberAdapter==null){
                    numberAdapter = new DWGameNumberAdapter(mContext,where,array,rate,money,handler,MoneyPoints,mybetpoints);
                }
