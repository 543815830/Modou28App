...
public class BetmodeDWFragment extends BaseFragment{
    private View view;
    ...
    int []array;
    String result;
  public DWFragment fmdw1= new DWFragment();
    ...
    private String[]tabs=new String[]{"总和","号码一","号码二","号码三"};
    ...
    protected View initView() {
        if (view == null) {
            ...
            //初始化view
            view=View.inflate(mContext, R.layout.fm_dw,null);
    ...
    protected View initVp() {
        ...
        //两个viewpager切换不重新加载
        //设置预加载
      //  fm_dw_vp.setOffscreenPageLimit(4);
        for (int i = 0; i < tabs.length; i++) {
    ...
    private void traversal4() {
        if(!exit){
            ...
            Fragment view1 =adapter.currentFragment;
         position=   fm_dw_vp.getCurrentItem();
            Log.e("tag","game_number_lv.getCount()"+view);
            ListView game_number_lv=view1.getView().findViewById(R.id.game_number_lv);
