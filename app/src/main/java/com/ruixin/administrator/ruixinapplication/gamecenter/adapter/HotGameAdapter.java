 ...
 * 邮箱：543815830@qq.com
 */
public class HotGameAdapter extends RecyclerView.Adapter<HotGameAdapter.ViewHolder> {
    private Context mContext;
    private List<GameName1.DataBean.HotgamelistBean> list;
    public HotGameAdapter(Context context, List<GameName1.DataBean.HotgamelistBean> list){
