...
import com.ruixin.administrator.ruixinapplication.usercenter.adapter.MyFechAdapter2;
 ...
 * 托管方案的popwindow
 */
public class MyFechPop2 extends PopupWindow {
    private View mainView;
  ListView my_trustee_lv;
    MyFechAdapter2 adapter;
    String  pid;
    int position;
    List<GoldDepositDb.DataBean.CardlistBean> fechlist;
    public MyFechPop2(Context paramActivity, final    List<GoldDepositDb.DataBean.CardlistBean> fechlist, final TextView etTrusteeName){
        super(paramActivity);
        //窗口布局
        ...
        adapter=new MyFechAdapter2(paramActivity,fechlist);
        this.fechlist=fechlist;
        my_trustee_lv.setAdapter(adapter);
        setListViewHeight(my_trustee_lv);
      adapter.setOnItemClickListener(new MyFechAdapter2.OnItemClickListener() {
          @Override
          public void OnItemClick(View view, int i) {
                  position=i;
                 etTrusteeName.setText(fechlist.get(i).getTypename());
                  dismiss();
