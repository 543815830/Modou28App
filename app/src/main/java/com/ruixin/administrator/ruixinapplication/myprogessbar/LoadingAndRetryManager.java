package com.ruixin.administrator.ruixinapplication.myprogessbar;
...
public class LoadingAndRetryManager
{
    ...
    public static int BASE_RETRY_LAYOUT_ID = R.layout.base_retry;
    public static int BASE_EMPTY_LAYOUT_ID = R.layout.base_empty;
