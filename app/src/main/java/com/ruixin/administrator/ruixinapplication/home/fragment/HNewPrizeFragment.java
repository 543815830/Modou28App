...
public class HNewPrizeFragment extends BaseFragment {
    private View view;
    ...
    private class MyPrizeAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            String result= AgentApi.dopost3(URL.getInstance().NewPrize_URL,prarams);
            ...
            if(s.length()>0){
                ...
                if (index == 0) {
                    ...
                    if (entry.getStatus() == 1) {
                        ...
                        List<HotPrize.DataBean.HotprizeBean> list = hotPrize.getData().getNewprize();
