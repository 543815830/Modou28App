...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class [com.ruixin.administrator.ruixinapplication].** { *; }
...
-dontwarn okio.**
#sharesdkShareSDK已经做了混淆处理，再次混淆会导致不可预期的错误，请在您的混淆脚本中添加如下的配置，跳过对ShareSDK的混淆操作
...
#下面中括号的地方需要要填你的包名
-keep public class [com.ruixin.administrator.ruixinapplication].R$*{
